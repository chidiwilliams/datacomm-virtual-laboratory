...
import classes.filters.HPF;
import classes.filters.BPF;
...
public class MasterSimulator extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(decodePanelLayout.createSequentialGroup()
                        .addGroup(decodePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(decodePanelLayout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(cutoffFreqLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
        ...
        impairmentPowerLabel.setFont(impairmentPowerLabel.getFont().deriveFont(impairmentPowerLabel.getFont().getStyle() & ~java.awt.Font.BOLD, impairmentPowerLabel.getFont().getSize()+3));
        impairmentPowerLabel.setForeground(new java.awt.Color(0, 0, 0));
        impairmentPowerLabel.setText("Power");

        impairmentPowerTextField.setFont(impairmentPowerTextField.getFont().deriveFont(impairmentPowerTextField.getFont().getStyle() & ~java.awt.Font.BOLD, impairmentPowerTextField.getFont().getSize()+3));
        impairmentPowerTextField.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        impairmentTypeComboBox.setFont(impairmentTypeComboBox.getFont().deriveFont(impairmentTypeComboBox.getFont().getStyle() & ~java.awt.Font.BOLD, impairmentTypeComboBox.getFont().getSize()+3));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, impairmentPanelLayout.createSequentialGroup()
                ...
                .addGroup(impairmentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, impairmentPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(impairmentTypeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(26, 26, 26))
        );
    ...
    private void sendInputButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendInputButtonActionPerformed
        if (validateInput()) {
            ...
            inputSignal = new Signal(4);
            inputSignal.setSignal(input);
            
            Signal xsignal = new Signal(testSamples);
            xsignal.setSignal(inputSignal.expandTo(testSamples));
            
            double[] c = new double[testSamples];
    ...
    private void encodeAndSampleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encodeAndSampleButtonActionPerformed
        if (validateEncodingandSampling()) {
            ...
            if (codingSchemeComboBox.getSelectedItem() == "HAMMING") {
                ...
                basebandSignal = new Signal(8);
                basebandSignal.setSignal(coded);
            }

            //          GET SAMPLING TIME
            samples = Integer.parseInt(sampleNoComboBox.getSelectedItem().toString());
            messageSignal = new Signal(samples);
            messageSignal.setSignal(basebandSignal.expandTo(samples));

            samplingInterval = sampleTime / samples;
    ...
    private void impairmentButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_impairmentButtonActionPerformed
        ...
        if (validateImpairment()) {
            if ("AWGN".equals(impairmentType)) {
                ...
                receivedSignal = new Signal(samples);
...
//          PLOT SAMPLES
    ...
    private void decodeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decodeButtonActionPerformed
        if (validateDecoding()) {
            ...
            Signal xsignal = new Signal(testSamples);
            xsignal.setSignal(decodedSignal.expandTo(testSamples));
    ...
    private void thresholdButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thresholdButtonActionPerformed
        if (validateThreshold()) {
            ...
            Signal xsignal = new Signal(testSamples);
            xsignal.setSignal(thresholdSignal.expandTo(testSamples));
    ...
    private void filterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filterButtonActionPerformed
        if (validateFiltering()) {
            ...
            filteredSignal = new Signal(samples);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterSimulator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
    ...
    private final int testSamples = 2048;
